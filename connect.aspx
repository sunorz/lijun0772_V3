<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cnts.aspx.cs" Inherits="cnts"%>
...
#title{
    ...
    body {
	background-image: url(imgs/class/bg9.jpg);
...
<table width="1038" border="0" align="center" cellpadding="0" cellspacing="0" class="layoute">
  ...
  <td colspan="9" height="20"><table align="center" cellspacing="0" width="1035px">
   ...
   <td  align="center" valign="middle" class="topbar"><a href="staff.aspx" class="ht">人才招聘</a></td>
    ...
    <td   align="center" valign="middle" class="ht" bgcolor="#E96800">联系我们</td>
 </tr>
      </table>
      </td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="12">
      <tr>
        <td colspan="9" align="middle" valign="middle"><img src="imgs/class/img9.gif" width="200" height="194" /><div id="title" runat="server"></div></td>
        </tr>
      <tr>
