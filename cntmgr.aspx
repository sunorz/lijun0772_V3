...
<form id="form1" runat="server">
  ...
  <tr height="40">
    ...
    <td  align="center" valign="middle" bgcolor="#ff7d23"><a href="bbs.aspx" class="ht" target="_blank">维修论坛</a></td>
            ...
            <td colspan="3" align="center" valign="middle"><div id="divchgpwd2" class="divcss2" runat="server" align="center">
              <table width="100%" border="0" cellspacing="0" cellpadding="12">
                <tr>
                  ...
                  <td width="50%" align="left"><strong>网上留言： </strong></td>
                </tr>
                <tr>
            ...
            <div id="divchgpwd" class="divcss2" runat="server" align="center">
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="12">
                <tr>
                  ...
                  <td align="left" width="50%"><strong>文章评论：            
                ...
                <tr>
                  <td colspan="2" align="center" valign="middle">
                      <p style="text-align: left; background-color: #CCCCCC">
                          注意：专用回复账号为：昵称：欧阳师傅，邮箱：ouyjj@ljsm.com。</p>
                              ...
                              <asp:BoundField DataField="artid" HeaderText="artid" InsertVisible="False" 
                                  ...
                                  <ItemTemplate>
                                      <asp:Button ID="Button1" runat="server" CausesValidation="False" 
                                          CommandName="Update" Text="删除" OnClientClick="javascript:return confirm('您确定删除该评论吗？');"/>
                                  </ItemTemplate>
                                  <ControlStyle BackColor="#FF7D23" BorderColor="#FF7D23" BorderStyle="Solid" 
                                      Font-Bold="True" Font-Names="宋体" Font-Size="Medium" ForeColor="White" />
                                          <HeaderStyle HorizontalAlign="Center" />
                      ...
                      <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                          ...
                          UpdateCommand="update [Comment] set comment='该评论被管理员删除！',gid=19,cflag=0 WHERE [comid] = @comid" >
                      </asp:SqlDataSource>
                      <p style="text-align: left; background-color: #CCCCCC">
                          注意：本表操作会彻底删除评论。</p>
